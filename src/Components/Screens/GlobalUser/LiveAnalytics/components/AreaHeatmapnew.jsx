...
console.log('areas', newAreas);
  ...
  if(area) {
  //   colorGradient = [
  //     // Lightest Red Shades (from what you provided)
  //     // { from: 0, to: Math.floor(maxValue * 0.05), color: '#66ff00', name: 'Very Low' },  // Light Red 1
  //     { from: 0, to: 0, color: '#006400', name: 'Dark Green' },  // Dark Green for zero values
  // { from: 1, to: Math.floor(maxValue * 0.05), color: '#66ff00', name: 'Very Low' },
  //     { from: Math.floor(maxValue * 0.05) + 1, to: Math.floor(maxValue * 0.1), color: '#66ff00', name: 'Low' },  // Light Red 2
  //     { from: Math.floor(maxValue * 0.1) + 1, to: Math.floor(maxValue * 0.15), color: '#66ff00', name: 'Moderate Low' },  // Light Red 3
  //     { from: Math.floor(maxValue * 0.15) + 1, to: Math.floor(maxValue * 0.2), color: '#75ff1a', name: 'Medium Low' },  // Light Red 4
  //     { from: Math.floor(maxValue * 0.2) + 1, to: Math.floor(maxValue * 0.25), color: '#85ff33', name: 'Moderate' },  // Slightly darker than #FF9494
  //     { from: Math.floor(maxValue * 0.25) + 1, to: Math.floor(maxValue * 0.3), color: '#94ff4d', name: 'Medium' },  // Light Red 5
  //     { from: Math.floor(maxValue * 0.3) + 1, to: Math.floor(maxValue * 0.35), color: '#a3ff66', name: 'Medium High' },  // Slightly darker than #FF5757
  //     { from: Math.floor(maxValue * 0.35) + 1, to: Math.floor(maxValue * 0.4), color: '#b3ff80', name: 'High' },  // Smooth transition
  //     { from: Math.floor(maxValue * 0.4) + 1, to: Math.floor(maxValue * 0.45), color: '#c2ff99', name: 'Very High' },  // Light Red 6
  //     { from: Math.floor(maxValue * 0.45) + 1, to: Math.floor(maxValue * 0.5), color: '#e0ffcc', name: 'Extreme' },  // Darker red approaching pure red
    
  //     // Darker Red Shades (from what you provided)
  //     { from: Math.floor(maxValue * 0.5) + 1, to: Math.floor(maxValue * 0.55), color: '#FFF0F0', name: 'Critical' },  // Pure Red
  //     { from: Math.floor(maxValue * 0.55) + 1, to: Math.floor(maxValue * 0.6), color: '#FFC0C0', name: 'Dark Red 1' },  // Slightly darker than #FF0000
  //     { from: Math.floor(maxValue * 0.6) + 1, to: Math.floor(maxValue * 0.65), color: '#FF7A7A', name: 'Dark Red 2' },  // Dark Red 2
  //     { from: Math.floor(maxValue * 0.65) + 1, to: Math.floor(maxValue * 0.7), color: '#FF4545', name: 'Dark Red 3' },  // Between #D70000 and #B30303
  //     { from: Math.floor(maxValue * 0.7) + 1, to: Math.floor(maxValue * 0.75), color: '#FF2323', name: 'Dark Red 4' },  // Dark Red 3
  //     { from: Math.floor(maxValue * 0.75) + 1, to: Math.floor(maxValue * 0.8), color: '#FF0000', name: 'Dark Red 5' },  // Smooth transition
  //     { from: Math.floor(maxValue * 0.8) + 1, to: Math.floor(maxValue * 0.85), color: '#D70000', name: 'Dark Red 6' },  // Dark Red 4
  //     { from: Math.floor(maxValue * 0.85) + 1, to: Math.floor(maxValue * 0.9), color: '#C10000', name: 'Dark Red 7' },  // Between #920A0A and #500000
  //     { from: Math.floor(maxValue * 0.9) + 1, to: Math.floor(maxValue * 0.95), color: '#A00000', name: 'Dark Red 8' },  // Smooth transition
  //     { from: Math.floor(maxValue * 0.95) + 1, to: maxValue, color: '#780000', name: 'Critical Dark Red' }  // Darkest red
  //   ];

  //green and red
  // colorGradient = [
  //   // Add a color range for zero values with dark green color
  //   { from: -1, to: 0, color: '#4abe00', name: 'Zero' }, // Dark Green for Zero values

  //   // Lightest Red Shades (from what you provided)
  //   { from: 1, to: Math.floor(maxValue * 0.05), color: '#58de00', name: 'Very Low' },  // Light Red 1
  //   { from: Math.floor(maxValue * 0.05) + 1, to: Math.floor(maxValue * 0.1), color: '#58de00', name: 'Low' },  // Light Red 2
  //   { from: Math.floor(maxValue * 0.1) + 1, to: Math.floor(maxValue * 0.15), color: '#66ff00', name: 'Moderate Low' },  // Light Red 3
  //   { from: Math.floor(maxValue * 0.15) + 1, to: Math.floor(maxValue * 0.2), color: '#75ff1a', name: 'Medium Low' },  // Light Red 4
  //   { from: Math.floor(maxValue * 0.2) + 1, to: Math.floor(maxValue * 0.25), color: '#85ff33', name: 'Moderate' },  // Slightly darker than #FF9494
  //   { from: Math.floor(maxValue * 0.25) + 1, to: Math.floor(maxValue * 0.3), color: '#94ff4d', name: 'Medium' },  // Light Red 5
  ...
  // colorGradient = [
  //   // Add a color range for zero values with dark green color
  //   { from: -1, to: 0, color: '#c9c9c9', name: 'Zero' }, // Dark Green for Zero values
  ...
  // ];
    ...
    // colorGradient = [
    //   // Lightest Red Shades (from what you provided)
    //   { from: -1, to: 0, color: '#c9c9c9', name: 'Zero' },
    //   { from: 1, to: Math.floor(maxValue * 0.05), color: '#FFDDDD', name: 'Very Low' }, 
    //   { from: 1, to: Math.floor(maxValue * 0.05), color: '#FFDDDD', name: 'Very Low' }, 
    //   { from: Math.floor(maxValue * 0.05) + 1, to: Math.floor(maxValue * 0.1), color: '#FFDDDD', name: 'Low' },  // Light Red 2
    //   { from: Math.floor(maxValue * 0.1) + 1, to: Math.floor(maxValue * 0.15), color: '#FFC0C0', name: 'Moderate Low' },  // Light Red 3
    //   { from: Math.floor(maxValue * 0.15) + 1, to: Math.floor(maxValue * 0.2), color: '#FF9494', name: 'Medium Low' },  // Light Red 4
    //   { from: Math.floor(maxValue * 0.2) + 1, to: Math.floor(maxValue * 0.25), color: '#FF7A7A', name: 'Moderate' },  // Slightly darker than #FF9494
    //   { from: Math.floor(maxValue * 0.25) + 1, to: Math.floor(maxValue * 0.3), color: '#FF5757', name: 'Medium' },  // Light Red 5
    //   { from: Math.floor(maxValue * 0.3) + 1, to: Math.floor(maxValue * 0.35), color: '#FF4545', name: 'Medium High' }, // Slightly darker than #FF5757
    //   { from: Math.floor(maxValue * 0.35) + 1, to: Math.floor(maxValue * 0.4), color: '#FF3232', name: 'High' },  // Smooth transition
    //   { from: Math.floor(maxValue * 0.4) + 1, to: Math.floor(maxValue * 0.45), color: '#FF2323', name: 'Very High' },  // Light Red 6
    //   { from: Math.floor(maxValue * 0.45) + 1, to: Math.floor(maxValue * 0.5), color: '#FF1414', name: 'Extreme' },  // Darker red approaching pure red
    
    //   // Darker Red Shades (from what you provided)
    //   { from: Math.floor(maxValue * 0.5) + 1, to: Math.floor(maxValue * 0.55), color: '#FF0000', name: 'Critical' },  // Pure Red
    //   { from: Math.floor(maxValue * 0.55) + 1, to: Math.floor(maxValue * 0.6), color: '#E50000', name: 'Dark Red 1' },  // Slightly darker than #FF0000
    //   { from: Math.floor(maxValue * 0.6) + 1, to: Math.floor(maxValue * 0.65), color: '#D70000', name: 'Dark Red 2' },  // Dark Red 2
    //   { from: Math.floor(maxValue * 0.65) + 1, to: Math.floor(maxValue * 0.7), color: '#C10000', name: 'Dark Red 3' },  // Between #D70000 and #B30303
    //   { from: Math.floor(maxValue * 0.7) + 1, to: Math.floor(maxValue * 0.75), color: '#B30303', name: 'Dark Red 4' },  // Dark Red 3
    //   { from: Math.floor(maxValue * 0.75) + 1, to: Math.floor(maxValue * 0.8), color: '#A00000', name: 'Dark Red 5' },  // Smooth transition
    //   { from: Math.floor(maxValue * 0.8) + 1, to: Math.floor(maxValue * 0.85), color: '#920A0A', name: 'Dark Red 6' },  // Dark Red 4
    //   { from: Math.floor(maxValue * 0.85) + 1, to: Math.floor(maxValue * 0.9), color: '#780000', name: 'Dark Red 7' },  // Between #920A0A and #500000
    //   { from: Math.floor(maxValue * 0.9) + 1, to: Math.floor(maxValue * 0.95), color: '#600000', name: 'Dark Red 8' },  // Smooth transition
    //   { from: Math.floor(maxValue * 0.95) + 1, to: maxValue, color: '#500000', name: 'Critical Dark Red' }  // Darkest red
    // ];
...
useEffect(() => {
  ...
  function formatCameraIDLabel(value, timestamp, opts) {
   try {
    const parts = value.split('-');
    return parts[parts.length - 1]; 
   } catch (error) {
    errorToast('Error while finding camera id for heatmap')
   }
  }
  setChartOptions((prevOptions) => ({
    ...
    xaxis: {
      ...
      categories:  heatmapData?.camera_mapping_id,
      labels: {
        show: true,
        trim: true, // Don't trim the text
        formatter: formatCameraIDLabel,
        maxHeight: 120, // Limit height of labels
    ...
    tooltip: {
      custom: function({ seriesIndex, dataPointIndex, w }) {
        ...
        console.log('areaOwner.length', areaOwner.length)
        return `<div class="custom-tooltip">
                  <span><strong>Camera ID:</strong> ${heatmapData?.camera_mapping_id[dataPointIndex]}</span>
                  <br/>
                  <span><strong>Alerts:</strong> ${value}</span>
                </div>`;
      }
