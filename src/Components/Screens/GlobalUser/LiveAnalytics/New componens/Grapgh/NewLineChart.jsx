...
import { TurnoverChart2,dummyforcandel } from '../../analytics_data_temp';
...
const NewLineChart = ({ chartData }) => { 
  ...
  const [TurnoverChartState, setTurnoverChartState] = useState(dummyforcandel)
  ...
  return (
    <Card>
      <CardHeader className='pb-0 mb-0' style={{borderBottom:'0px'}}>
        <Row>
          <Col xs="12" sm='7' md='6' className="d-flex align-items-center">
            <h5 className="">Alerts Trend </h5>
            {/* <span className="f-light alerts-trend-span">
      ...
      <CardBody className="p-0 p-md-4 pt-md-0 pt-0" >
        <div className="chart-container">
          <Row>
            <Col>
              <div id="chart-widget7">

                {chartLoader ? <div className='d-flex justify-content-center align-items-center w-100' style={{ height: '350px' }}><Loader3 /></div> : 
                <Chart
