...
const AddCompany = ({ toggleModal, modal, modalType, handleSave, generateUserId, generatePassword, handleCheckboxChange }) => {
                ...
                <form action="" className='add-compnay-form'>
                    ...
                    <Row>
                        ...
                        <Col xs='12' className='card mb-2 add-company-card'>
                            ...
                            <FormGroup>
                                <Label for="email">Factory Email</Label>
                            ...
                            <Col className='mb-3'>
                                <Label for='role'>How Many Areas are in Company</Label>
                                <Input
